...
- Product 新增 `evidence_collection_v2/scripts/run_parallel_claude_agents.py`，参考 `Develop/row-batch/scripts/run_claude.py`，改为通过两个 `claude -p` worker 并发执行 web 与 map 分支。
