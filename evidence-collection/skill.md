...
- 图商直连脚本只接受 `city + poi name + source + credential`
...
```bash
python evidence-collection/scripts/call_map_vendor.py -PoiName <poi-name> -City <city> -Source <amap|bmap|qmap> -Credential <ak-or-key> -OutputPath <vendor-fallback.json>
```
