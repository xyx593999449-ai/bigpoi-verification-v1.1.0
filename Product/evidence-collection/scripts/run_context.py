...
if __name__ == "__main__":
    raise SystemExit("This module is import-only. Use run_evidence_collection.py, run_parallel_claude_agents.py, build_web_source_plan.py, build_webreader_plan.py, websearch_adapter.py, webreader_adapter.py, call_internal_proxy.py, call_map_vendor.py, merge_evidence_collection_outputs.py, or write_evidence_output.py.")
