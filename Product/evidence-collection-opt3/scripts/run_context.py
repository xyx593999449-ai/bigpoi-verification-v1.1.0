...
if __name__ == "__main__":
    raise SystemExit("This module is import-only. Use build_web_source_plan.py, call_internal_proxy.py, call_map_vendor.py, merge_evidence_collection_outputs.py, or write_evidence_output.py.")
